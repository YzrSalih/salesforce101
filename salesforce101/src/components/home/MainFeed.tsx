  ...
  return (
    <div className="space-y-12">
      ...
      <div className="flex items-center gap-3">
        {["Latest", "Most Popular", "Editors' Picks"].map((t, i) => (
          <button
            key={t}
            className={
              i === 0
                ? 'px-4 py-2 text-sm font-semibold rounded border border-salesforce-indigo text-salesforce-indigo bg-salesforce-indigo/10 dark:bg-salesforce-indigo/15 shadow-sm'
                : 'px-4 py-2 text-sm font-semibold rounded border border-gray-300 dark:border-gray-700 hover:border-salesforce-indigo/60 hover:bg-salesforce-indigo/5'
            }
          >
            {t}
          </button>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10 items-stretch">
        {/* Big left feature */}
        <article className="md:col-span-2 relative p-8 border border-gray-200 dark:border-gray-800 rounded-2xl bg-white dark:bg-gray-900 overflow-hidden">
